import {GET_COUNTRIES, GET_COUNTRY, GET_BY_NAME, FILTER_CONTINENT, FILTER_ACTIVITY, GET_ACTIVITY, ORDER_BY_NAME} from '../actions/actions'
...
/*             let sortedCountries = action.payload === 'asc' ?
            ...
            switch (action.payload) {
                ...
                case 'normal':
                    const normalOrder= state.countries
                    return{
                        ...state,
                        countries:normalOrder
                    };
                default:
                    return{
                        ...state,
